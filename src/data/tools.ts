...
export const tools: ToolMeta[] = [
  ...
  },
  {
    id: 'logcat-analyzer',
    name: 'Logcat 日志分析',
    description: '本地解析 Logcat，提取崩溃、ANR、Native 和网络异常。',
  ...
  {
    id: 'mapping-retrace',
    name: 'R8 / ProGuard Retrace',
    description: '使用本地 mapping.txt 反混淆 Java / Kotlin 堆栈。',
    path: '/mapping-retrace',
    tags: ['Android', '构建'],
    accent: '#84cc16',
  },
  {
    id: 'manifest-security',
    name: 'Manifest 安全检查',
    description: '本地检查 AndroidManifest.xml 的导出、权限与网络配置。',
  ...
  },
  {
    ...
    name: 'Android 图标生成',
    description: '本地生成 mipmap 密度图标和 Adaptive Icon XML。',
    path: '/android-icon-generator',
    tags: ['Android', 'UI', '图片'],
    accent: '#f59e0b',
  },
  {
    id: 'json-kotlin-generator',
    name: 'JSON 转 Kotlin data class',
    description: '从样例 JSON 本地生成 Kotlin 数据类和序列化注解。',
    path: '/json-kotlin-generator',
    tags: ['Android', '编码'],
    accent: '#6366f1',
  },
  {
    id: 'app-links-assistant',
    name: 'Deep Link / App Links 测试',
    description: '生成 adb 调试命令并本地检查 assetlinks 配置。',
